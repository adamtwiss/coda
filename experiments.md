...
| #834 | experiment/tt-replacement-pv-bonus | running, **trending H1 +2.6 ±6.0 / 2618g** (LLR 0.28). SF-style TT replacement: EXACT-always-wins + `+2*is_pv` depth bonus + threshold loosened from -3 to -4. Mirrors SF/Reckless/Obsidian (SF tt.cpp:101). Coda's same-key replacement gate was missing both EXACT priority and PV bonus. Bench 1048892. |
| #835 | experiment/tune-830-applied vs e68dcc9 (both with xray net 6C154331) | running, **trending H1 +5.2 ±4.9 / 3330g** (LLR 0.92). Pre-vs-post tune-830 retune. Confirms SPSA converged usefully — 64 changed tunables collectively buy ~+5 Elo on the new net relative to default tunables. |
| #836 | experiment/tune-830-applied (xray net) vs main (prod net 1EF1C3E5) | **H0 -10.7 ±6.3 / 3100g** (LLR -2.97). Net-vs-net at retuned state. **The factor-C8fix-xray SB800 net is NOT a deployment-ready replacement** — even with its own SPSA optimum (#830), it's ~10 Elo worse than current trunk (prod net 1EF1C3E5 + tune-820). Combined with #835 +5.2 implies the underlying net is ~15 Elo behind prod at equal-tune state. **Action:** don't retire prod 1EF1C3E5; net-training thread needs to iterate (training recipe, more SBs, alternative architecture). |
