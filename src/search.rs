...
tunables!(
    ...
    // Futility
    (FUT_BASE,          84,   20,  200),
    (FUT_PER_DEPTH,    151,   40,  250),
    // History pruning
    (HIST_PRUNE_DEPTH,   2,    1,    8),
    (HIST_PRUNE_MULT, 2119,  500, 50000),
    // SEE pruning
    (SEE_QUIET_MULT,   25,    5,   80),
    (SEE_CAP_MULT,    131,   30,  200),
    // LMR
    (LMR_HIST_DIV,   9156, 2000, 100000),
    (LMR_C_QUIET,     139,   80,  300),
    (LMR_C_CAP,       184,  100,  350),
    // Singular extensions
    (SE_DEPTH,           6,    4,   12),
    // Aspiration windows
    (ASP_DELTA,         16,    5,   30),
    ...
    // Hindsight
    (HINDSIGHT_THRESH, 190,   50,  400),
    // QS
    (QS_DELTA_MARGIN,  243,  100,  500),
    (QS_SEE_THRESHOLD,  -7, -200,    0),
    (QS_MAX_CAPTURES,   30,    2,   32),
    // Correction history weights
    (CORR_W_PAWN,      347,  100,  600),
    (CORR_W_NP,        150,   50,  400),
    (CORR_W_MINOR,      99,   30,  300),
