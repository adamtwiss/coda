...
tunables!(
    ...
    (NMP_EVAL_DIV, 134, 100, 400, 15.0),
    (NMP_EVAL_MAX, 6, 1, 6, 1.5),
    (NMP_VERIFY_DEPTH, 12, 8, 20, 2.0),
    (RFP_DEPTH, 8, 2, 12, 2.0),
    (RFP_MARGIN_IMP, 67, 30, 150, 6.0),
    (RFP_MARGIN_NOIMP, 131, 50, 200, 7.5),
    (FUT_BASE, 66, 20, 200, 9.0),
    (FUT_PER_DEPTH, 162, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 4, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 6022, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 46, 5, 80, 3.75),
    (SEE_CAP_MULT, 145, 30, 200, 8.5),
    (LMR_HIST_DIV, 12310, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 120, 40, 300, 13.0),
    (LMR_C_CAP, 110, 100, 350, 12.5),
    (SE_DEPTH, 4, 4, 20, 2.0),
    (ASP_DELTA, 14, 5, 30, 1.5),
    (ASP_SCORE_DIV, 33241, 8000, 50000, 2100.0),
    ...
    (HIST_BONUS_MAX, 1707, 500, 3000, 125.0),
    ...
    (QUIET_CHECK_BONUS, 10825, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 179, 30, 500, 23.5),
    (CORR_HIST_DIV, 962, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 16, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV, 5, 1, 16, 1.5),
    (CORR_HIST_GRAIN_T, 10, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX, 5, 1, 64, 3.15),
    (ESCAPE_BONUS_Q, 15655, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 12492, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 8810, 2000, 20000, 900.0),
