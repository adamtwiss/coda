...
tunables!(
    ...
    // Futility
    (FUT_BASE,          66,   20,  200),
    (FUT_PER_DEPTH,    170,   40,  250),
    // History pruning
    (HIST_PRUNE_DEPTH,   4,    1,    8),
    (HIST_PRUNE_MULT, 5796,  500, 50000),
    // SEE pruning
    (SEE_QUIET_MULT,   36,    5,   80),
    (SEE_CAP_MULT,    144,   30,  200),
    // LMR
    (LMR_HIST_DIV,  13110, 2000, 100000),
    (LMR_C_QUIET,      104,   40,  300),
    (LMR_C_CAP,       119,  100,  350),
    // Singular extensions
    (SE_DEPTH,          10,    4,   20),
    // Aspiration windows
    (ASP_DELTA,          8,    5,   30),
    (ASP_SCORE_DIV,  38366, 8000, 50000),
    // LMP
    (LMP_BASE,          12,    1,   15),
    (LMP_DEPTH,         10,    4,   20),
    // Bad noisy
    ...
    (ESCAPE_BONUS_Q,   17422, 5000, 40000),
    (ESCAPE_BONUS_R,   15765, 3000, 30000),
    (ESCAPE_BONUS_MINOR, 9812, 2000, 20000),
