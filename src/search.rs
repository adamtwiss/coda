...
tunables!(
    ...
    (HIST_BONUS_OFFSET, 9, 0, 400, 25.0),
    (CAP_HIST_MULT, 287, 50, 400, 17.5),
    (CAP_HIST_BASE, 36, 0, 200, 10.0),
    (CAP_HIST_MAX, 1652, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_QUIET, 5, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 14, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 38, -50, 150, 6.0),
    (DEXT_CAP, 12, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 12206, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 176, 30, 500, 23.5),
    (CORR_HIST_DIV, 1136, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 16484, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 11363, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5594, 2000, 20000, 900.0),
    ...
    (FUT_THREATS_MARGIN, 23, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 5694, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7425, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6660, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 9486, 0, 20000, 1000.0),
