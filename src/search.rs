...
tunables!(
    ...
    (NMP_BASE_R_10X, 66, 20, 80, 15.0, true),
    (NMP_DEPTH_DIV_10X, 40, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 55, 50, 400, 17.5, true),
    ...
    (NMP_VERIFY_DEPTH_10X, 46, 40, 200, 20.0, true),
    (RFP_DEPTH, 20, 2, 20, 2.0, true),
    (RFP_MARGIN_IMP, 23, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 26, 0, 200, 7.5, true),
    ...
    (RFP_DEEP_QUAD_10X, 16, 0, 800, 50.0, true),
    ...
    (RAZOR_DEPTH_10X, 34, 10, 80, 5.0, true),
    ...
    (FUT_BASE, 82, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 84, 40, 250, 10.5, true),
    (FUT_LMR_DEPTH, 11, 6, 24, 2.0, true),
    ...
    (LMR_HIST_DIV, 24114, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1027, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 170, 40, 300, 13.0, true),
    (LMR_C_CAP, 201, 80, 350, 12.5, true),
    ...
    (LMR_BASE_CENTI, 32, 0, 120, 6.0, true),
    (LMR_ALLNODE_DECAY_NUM, 506, 0, 1600, 80.0, true),
    ...
    (LMR_TTALPHA_CENTI, 11, 0, 150, 8.0, true),
    (LMR_EXPECT_MULT, 22, 0, 120, 6.0, true),
    ...
    (LMR_CUTOFF_CNT_CENTI, 68, 0, 250, 12.0, true),
    (LMR_CUTOFF_ALLNODE_CENTI, 16, 0, 150, 8.0, true),
    ...
    (LMP_BASE_10X, 38, 10, 150, 20.0, true),
    (LMP_DEPTH_10X, 104, 40, 200, 20.0, true),
    ...
    (LMR_ROOT_COEF_10X, 3, 0, 800, 40.0, true),
    (BAD_NOISY_MARGIN, 88, 30, 150, 6.0, true),
    ...
    (HINDSIGHT_THRESH, 149, 50, 400, 17.5, true),
    ...
    (CORR_W_PAWN, 147, 100, 600, 25.0, true),
    ...
    (CORR_W_CONT, 157, 0, 400, 18.5, true),
    ...
    (CORR_W_TRANS, 106, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 273, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1735, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 346, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1874, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 503, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 30, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1177, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 250, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 2236, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 146, 64, 1024, 40.0, true),
    ...
    (DEXT_MARGIN_CORR, 19, 0, 64, 3.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 85, 0, 300, 12.0, true),
    ...
    (CORR_HIST_DIV, 285, 64, 4096, 64.0, true),
    ...
    (CORR_UPDATE_WEIGHT_MAX, 15, 4, 48, 2.2, true),
    // Fixed-point /10.
    ...
    (NMP_KING_ZONE_MAX_10X, 33, 20, 90, 15.0, true),
    (PROBCUT_KING_ZONE_MAX_10X, 69, 20, 90, 15.0, true),
    (LMR_THREAT_DIV_10X, 39, 10, 50, 15.0, true),
    (LMR_KING_PRESSURE_DIV_10X, 69, 20, 90, 15.0, true),
    ...
    (FUT_THREATS_MARGIN, 55, 0, 200, 10.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 20, 0, 400, 20.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 43, 5, 100, 15.0, true),
    (PROBCUT_MIN_DEPTH_10X, 15, 10, 120, 15.0, false),     // ProbCut activation gate
    (PROBCUT_ROOT_MIN_DEPTH_10X, 28, 0, 80, 8.0, true),
    (SEE_CAP_DEPTH_10X, 72, 30, 150, 15.0, true),         // SEE capture prune depth cap
    ...
    (SEE_CAP_MULT, 88, 40, 250, 12.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 60, 20, 200, 15.0, true),
    (HINDSIGHT_MIN_DEPTH_10X, 33, 0, 200, 15.0, true),
