...
tunables!(
    ...
    (FUT_BASE, 37, 20, 200, 9.0),
    (FUT_PER_DEPTH, 72, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 3, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 12775, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 32, 5, 80, 3.75),
    (LMR_HIST_DIV, 8146, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 136, 40, 300, 13.0),
    (LMR_C_CAP, 106, 80, 350, 12.5),
    (SE_DEPTH, 4, 4, 20, 2.0),
    (ASP_DELTA, 11, 5, 30, 1.5),
    (ASP_SCORE_DIV, 29529, 8000, 50000, 2100.0),
    (LMP_BASE, 9, 1, 15, 2.0),
    (LMP_DEPTH, 11, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 71, 30, 150, 6.0),
    (PROBCUT_MARGIN, 200, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 152, 50, 400, 17.5),
    (UNSTABLE_THRESH, 205, 50, 500, 22.5),
    ...
    (CORR_W_CONT, 43, 30, 400, 18.5),
    (CORR_W_COUNTER, 75, 30, 400, 18.0),
    (CORR_W_FOLLOW_UP, 72, 30, 400, 18.0),
    (FH_BLEND_DEPTH, 3, 0, 8, 1.5),
    (HIST_BONUS_MULT, 326, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1784, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 14, 0, 400, 25.0),
    (CAP_HIST_MULT, 281, 50, 400, 17.5),
    (CAP_HIST_BASE, 35, 0, 200, 10.0),
    (CAP_HIST_MAX, 1633, 500, 3000, 125.0),
    ...
    (ESCAPE_BONUS_Q, 15373, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10327, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5602, 2000, 20000, 900.0),
    ...
    (DISCOVERED_ATTACK_BONUS, 6061, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 7526, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6486, 0, 20000, 1000.0),
    ...
    (SE_XRAY_BLOCKER_MARGIN, 1, 0, 40, 2.0),
    (MVV_CAP_MULT, 32, 4, 64, 3.0),
    (CONT_HIST_MULT, 1, 1, 8, 1.5),
    (KNIGHT_FORK_BONUS, 9081, 0, 20000, 1000.0),
