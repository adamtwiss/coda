...
tunables!(
    ...
    (RFP_MARGIN_NOIMP, 130, 50, 200),
    // Futility
    (FUT_BASE, 64, 20, 200),
    (FUT_PER_DEPTH, 160, 40, 250),
    // History pruning
    (HIST_PRUNE_DEPTH, 4, 1, 8),
    (HIST_PRUNE_MULT, 3734, 500, 50000),
    // SEE pruning
    (SEE_QUIET_MULT, 43, 5, 80),
    (SEE_CAP_MULT, 146, 30, 200),
    // LMR
    (LMR_HIST_DIV, 8011, 2000, 100000),
    (LMR_C_QUIET, 131, 40, 300),
    (LMR_C_CAP, 101, 100, 350),
    // Singular extensions
    (SE_DEPTH, 4, 4, 20),
    // Aspiration windows
    (ASP_DELTA, 12, 5, 30),
    (ASP_SCORE_DIV, 34119, 8000, 50000),
    // LMP
    (LMP_BASE, 13, 1, 15),
    (LMP_DEPTH, 9, 4, 20),
    // Bad noisy
    ...
    (SEE_MATERIAL_SCALE, 185, 30, 300),
    // QS
    (QS_DELTA_MARGIN, 364, 100, 500),
    (QS_SEE_THRESHOLD, -31, -200, 0),
    (QS_MAX_CAPTURES, 27, 2, 32),
    // Correction history weights
    (CORR_W_PAWN, 296, 100, 600),
    (CORR_W_NP, 101, 50, 400),
    (CORR_W_MINOR, 62, 30, 300),
    (CORR_W_MAJOR, 99, 30, 300),
    (CORR_W_CONT, 47, 30, 400),
    // Fail-high blend
    (FH_BLEND_DEPTH, 1, 0, 8),
    // History bonus
    (HIST_BONUS_MULT, 298, 50, 400),
    (HIST_BONUS_MAX, 1660, 500, 3000),
    // Capture history bonus
    (CAP_HIST_MULT, 265, 50, 400),
    (CAP_HIST_BASE, 16, 0, 200),
    (CAP_HIST_MAX, 1688, 500, 3000),
    // Double extensions
    (DEXT_MARGIN, 10, 2, 50),
    (DEXT_CAP, 18, 4, 32),
    // Quiet check bonus
    (QUIET_CHECK_BONUS, 9363, 2000, 30000),
    // LMR complexity
    ...
    (ESCAPE_BONUS_Q, 15761, 5000, 40000),
    (ESCAPE_BONUS_R, 13190, 3000, 30000),
    (ESCAPE_BONUS_MINOR, 10200, 2000, 20000),
    ...
    (DISCOVERED_ATTACK_BONUS, 7798, 0, 30000),
