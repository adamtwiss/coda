...
tunables!(
    ...
    (NMP_DEPTH_DIV,      3,    2,    6),
    (NMP_EVAL_DIV,     139,  100,  400),  // malus tune: 148→135
    (NMP_EVAL_MAX,       1,    1,    6),
    ...
    // Futility
    (FUT_BASE,         116,   20,  200),  // malus tune: 94→109
    (FUT_PER_DEPTH,    170,   40,  250),  // malus tune: 161→173
    // History pruning
    (HIST_PRUNE_DEPTH,   2,    1,    8),
    (HIST_PRUNE_MULT, 6763,  500, 50000),  // malus tune: 7224→6930
    // SEE pruning
    (SEE_QUIET_MULT,   19,    5,   80),  // malus tune: 23→24
    (SEE_CAP_MULT,    125,   30,  200),
    // LMR
    (LMR_HIST_DIV,   7055, 2000, 100000),  // malus tune: 9110→7454
    ...
    (LMR_COMPLEXITY_DIV, 140, 30, 500),
    // Good/bad quiet split threshold (SF: -14000). Quiets below this
    // are deferred after bad captures.
    (QUIET_SPLIT_THRESH, -14499, -30000, 0),
);
