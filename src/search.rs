...
tunables!(
    ...
    (NMP_EVAL_DIV, 121, 50, 400, 17.5, true),
    ...
    (RAZOR_MULT, 291, 100, 500, 20.0, true),
    ...
    (SEE_QUIET_MULT, 29, 5, 80, 3.75, true),
    ...
    (BAD_NOISY_MARGIN, 74, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 125, 80, 300, 11.0, true),
    ...
    (PROBCUT_MARGIN_IMP, 38, 0, 120, 8.0, true),
    ...
    (PROBCUT_ROOT_MARGIN, 59, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 173, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 310, 50, 500, 22.5, false),
    (QS_DELTA_MARGIN, 362, 100, 500, 20.0, true),
    ...
    (CORR_W_TRANS, 64, 0, 400, 18.5, true),
    ...
    (DEXT_MARGIN_PV, 165, 50, 400, 15.0, true),
    ...
    (NMP_UNDEFENDED_MAX_10X, 14, 1, 50, 10.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 27, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (SEE_CAP_MULT, 115, 40, 250, 12.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 36, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
