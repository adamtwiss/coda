...
tunables!(
    ...
    (RFP_MARGIN_NOIMP, 55, 50, 200, 7.5),
    ...
    (FUT_BASE, 45, 20, 200, 9.0),
    (FUT_PER_DEPTH, 90, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 4, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 11106, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 33, 5, 80, 3.75),
    (LMR_HIST_DIV, 7552, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 135, 40, 300, 13.0),
    (LMR_C_CAP, 120, 80, 350, 12.5),
    (SE_DEPTH, 4, 4, 20, 2.0),
    (ASP_DELTA, 9, 5, 30, 1.5),
    (ASP_SCORE_DIV, 27093, 8000, 50000, 2100.0),
    (LMP_BASE, 8, 1, 15, 2.0),
    (LMP_DEPTH, 10, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 72, 30, 150, 6.0),
    (PROBCUT_MARGIN, 197, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 162, 50, 400, 17.5),
    (UNSTABLE_THRESH, 261, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 248, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 350, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -36, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 30, 2, 32, 2.0),
    (CORR_W_PAWN, 237, 100, 600, 25.0),
    (CORR_W_NP, 53, 50, 400, 17.5),
    (CORR_W_MINOR, 75, 30, 300, 13.5),
    (CORR_W_MAJOR, 124, 30, 300, 13.5),
    (CORR_W_CONT, 62, 30, 400, 18.5),
    (FH_BLEND_DEPTH, 2, 0, 8, 1.5),
    (HIST_BONUS_MULT, 359, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1705, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 24, 0, 400, 25.0),
    (CAP_HIST_MULT, 285, 50, 400, 17.5),
    (CAP_HIST_BASE, 2, 0, 200, 10.0),
    (CAP_HIST_MAX, 1614, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_PV, 219, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 11, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 15, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 40, -50, 150, 6.0),
    (DEXT_CAP, 10, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 10499, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 194, 30, 500, 23.5),
    (CORR_HIST_DIV, 1380, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 8, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV, 2, 1, 16, 1.5),
    (CORR_HIST_GRAIN_T, 10, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX, 2, 1, 64, 3.15),
    (ESCAPE_BONUS_Q, 14565, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10588, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 6968, 2000, 20000, 900.0),
    (NMP_KING_ZONE_MAX, 7, 2, 9, 1.5),
    ...
    (MOBILITY_DELTA_WEIGHT, 39, 0, 256, 8.0),
    (PROBCUT_KING_ZONE_MAX, 8, 2, 9, 1.5),
    (LMR_THREAT_DIV, 5, 1, 5, 1.5),
    (LMR_KING_PRESSURE_DIV, 8, 2, 9, 1.5),
    (FUT_THREATS_MARGIN, 24, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 4253, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 6543, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 5278, 0, 20000, 1000.0),
    ...
    (MVV_CAP_MULT, 38, 4, 64, 3.0),
    (CONT_HIST_MULT, 1, 1, 8, 1.5),
    (KNIGHT_FORK_BONUS, 9525, 0, 20000, 1000.0),
    ...
    (SEE_CAP_DEPTH, 5, 3, 15, 1.5),         // was hardcoded 6 (SEE capture prune depth cap); tune-928 → 5
    (FUT_LMR_DEPTH, 17, 5, 20, 1.5),         // was hardcoded 10; tune-928 → 17
    (BAD_NOISY_DEPTH, 11, 4, 15, 1.5),       // was hardcoded 4 (BNFP depth cap); tune-928 → 11
    ...
    (TT_CUTOFF_HALFMOVE_MAX, 89, 50, 100, 3.0),  // was hardcoded 90; tune-928 → 89
);
