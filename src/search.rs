...
tunables!(
    ...
    (HIST_PRUNE_MULT, 4132, 500, 50000),
    // SEE pruning
    (SEE_QUIET_MULT, 43, 5, 80),
    (SEE_CAP_MULT, 144, 30, 200),
    // LMR
    (LMR_HIST_DIV, 9101, 2000, 100000),
    ...
    // Aspiration windows
    (ASP_DELTA, 12, 5, 30),
    (ASP_SCORE_DIV, 34214, 8000, 50000),
    // LMP
    (LMP_BASE, 13, 1, 15),
    (LMP_DEPTH, 10, 4, 20),
    // Bad noisy
    ...
    (CORR_W_PAWN, 280, 100, 600),
    (CORR_W_NP, 114, 50, 400),
    ...
    (CAP_HIST_MAX, 1659, 500, 3000),
    // Double extensions
    (DEXT_MARGIN, 11, 2, 50),
    (DEXT_CAP, 18, 4, 32),
    // Quiet check bonus
    (QUIET_CHECK_BONUS, 9102, 2000, 30000),
    // LMR complexity
    (LMR_COMPLEXITY_DIV, 183, 30, 500),
    // Contempt
    // Correction history divisor
    (CORR_HIST_DIV, 1214, 256, 4096),
    ...
    (ESCAPE_BONUS_Q, 16315, 5000, 40000),
    (ESCAPE_BONUS_R, 12929, 3000, 30000),
    (ESCAPE_BONUS_MINOR, 9450, 2000, 20000),
    ...
    (DISCOVERED_ATTACK_BONUS, 7920, 0, 30000),
