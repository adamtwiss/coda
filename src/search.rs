...
tunables!(
    ...
    (NMP_DEPTH_DIV,      3,    2,    6),
    (NMP_EVAL_DIV,     134,  100,  400),  // malus tune: 148→135
    (NMP_EVAL_MAX,       1,    1,    6),
    (NMP_VERIFY_DEPTH,  11,    8,   20),
    // RFP
    (RFP_DEPTH,          5,    4,   10),
    (RFP_MARGIN_IMP,    92,   30,  150),  // malus tune: 92→94
    ...
    (HIST_PRUNE_MULT, 6741,  500, 50000),  // malus tune: 7224→6930
    // SEE pruning
    (SEE_QUIET_MULT,   23,    5,   80),  // malus tune: 23→24
    (SEE_CAP_MULT,    124,   30,  200),
    // LMR
    (LMR_HIST_DIV,   6716, 2000, 100000),  // malus tune: 9110→7454
    ...
    // Bad noisy
    (BAD_NOISY_MARGIN,  93,   30,  150),  // malus tune: 91→92
    // ProbCut
