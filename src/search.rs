...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 68, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 110, 50, 400, 17.5, true),
    ...
    (NMP_VERIFY_DEPTH_10X, 106, 40, 200, 20.0, true),
    (RFP_DEPTH, 18, 2, 20, 2.0, true),
    // Floors lifted to 0 (audit 2026-05-20): both pinned within ~10% of floor.
    (RFP_MARGIN_IMP, 28, 0, 150, 6.0, true),
    (RFP_MARGIN_NOIMP, 29, 0, 200, 7.5, true),
    ...
    (RFP_ROOT_THRESH, 15, 6, 30, 1.5, true),
    (RFP_ROOT_COEF, 30, 0, 150, 7.5, true),
    ...
    (RFP_DEEP_KNEE, 7, 4, 17, 2.0, true),
    (RFP_DEEP_LINEAR, 48, 0, 200, 10.0, true),
    (RFP_DEEP_QUAD, 5, 0, 80, 5.0, true),
    ...
    (RAZOR_MULT, 284, 100, 500, 20.0, true),
    ...
    (FUT_BASE, 71, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 96, 40, 250, 10.5, true),
    ...
    (LMR_HIST_DIV, 13931, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 1727, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 143, 40, 300, 13.0, true),
    (LMR_C_CAP, 166, 80, 350, 12.5, true),
    ...
    (BAD_NOISY_MARGIN, 76, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 119, 80, 300, 11.0, true),
    ...
    (PROBCUT_ROOT_MARGIN, 62, 0, 120, 8.0, true),
    (HINDSIGHT_THRESH, 182, 50, 400, 17.5, true),
    (UNSTABLE_THRESH, 310, 50, 500, 22.5, false),
    (QS_DELTA_MARGIN, 377, 100, 500, 20.0, true),
    ...
    (CORR_W_CONT, 92, 0, 400, 18.5, true),
    ...
    (CORR_W_TRANS, 73, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 316, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1512, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 320, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1845, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 290, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 24, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1345, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 301, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 1743, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 264, 64, 1024, 40.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 72, 0, 300, 12.0, true),
    (CORR_HIST_DIV, 1128, 256, 4096, 192.0, true),
    ...
    (LMR_THREAT_DIV_10X, 22, 10, 50, 15.0, true),
    // Was 68 (tp10→7). Now FIXED-POINT. Default 70 → eff 7.0 ≡ old behavior.
    (LMR_KING_PRESSURE_DIV_10X, 58, 20, 90, 15.0, true),
    ...
    (LMR_ALPHA_RAISE_10X, 13, 0, 40, 5.0, true),
    ...
    (SE_XRAY_BLOCKER_MARGIN_10X, 55, 0, 400, 20.0, true),
    ...
    (LMR_ENDGAME_PIECES_10X, 51, 45, 90, 15.0, true),
    ...
    (IIR_MIN_DEPTH_10X, 42, 5, 100, 15.0, true),          // was hardcoded 4; tune #743 converged to 2 (strong signal)
    ...
    (PROBCUT_MIN_DEPTH_10X, 22, 10, 120, 15.0, true),     // was hardcoded 5 (ProbCut activation gate)
    (PROBCUT_ROOT_MIN_DEPTH_10X, 37, 0, 80, 8.0, true),
    ...
    (SEE_CAP_MULT, 105, 40, 250, 12.0, true),
    ...
    (NMP_MIN_DEPTH_10X, 43, 20, 200, 15.0, true),              // was hardcoded 3 (NMP activation gate, 2 sites)
    ...
    (HINDSIGHT_MIN_DEPTH_10X, 27, 0, 200, 15.0, true),
