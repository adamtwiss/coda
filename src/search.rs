...
tunables!(
    ...
    (NMP_DEPTH_DIV_10X, 35, 10, 200, 15.0, true),
    (NMP_EVAL_DIV, 85, 50, 400, 17.5, true),
    ...
    (NMP_VERIFY_DEPTH_10X, 57, 40, 200, 20.0, true),
    ...
    (RFP_DEEP_KNEE_10X, 46, 40, 170, 20.0, true),
    (RFP_DEEP_LINEAR, 46, 0, 200, 10.0, true),
    ...
    (FUT_HIST_EXEMPT, 12447, 2000, 16384, 900.0, true),
    (FUT_LMR_DEPTH, 17, 6, 24, 2.0, true),
    ...
    (SEE_QUIET_MULT, 19, 5, 80, 3.75, true),
    ...
    (LMR_HIST_DIV, 30863, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 2700, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 186, 40, 300, 13.0, true),
    ...
    (LMR_CUTOFF_CNT_CENTI, 73, 0, 250, 12.0, true),
    ...
    (LMP_DEPTH_10X, 108, 40, 200, 20.0, true),
    ...
    (LMP_MARGIN_THRESH, 56, 50, 500, 35.0, true),
    (LMP_MARGIN_PCT, 57, 40, 100, 6.0, true),
    ...
    (LMR_ROOT_COEF_10X, 19, 0, 800, 40.0, true),
    (BAD_NOISY_MARGIN, 80, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 177, 80, 300, 11.0, true),
    ...
    (HINDSIGHT_THRESH, 143, 50, 400, 17.5, true),
    (QS_DELTA_MARGIN, 391, 100, 500, 20.0, true),
    ...
    (CORR_W_PAWN, 115, 100, 600, 25.0, true),
    (CORR_W_NP, 131, 0, 400, 17.5, true),
    ...
    (CORR_W_CONT, 202, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 254, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1640, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 332, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1988, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 566, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 30, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1056, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 276, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 2228, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 136, 64, 1024, 40.0, true),
    ...
    (SE_ROOT_DECIDED_CP, 788, 250, 5000, 150.0, true),
    ...
    (CORR_HIST_DIV, 309, 64, 4096, 64.0, true),
    ...
    (CORR_UPDATE_WEIGHT_MAX, 19, 4, 48, 2.2, true),
    // Fixed-point /10.
    ...
    (NMP_KING_ZONE_MAX_10X, 39, 20, 90, 15.0, true),
    (PROBCUT_KING_ZONE_MAX_10X, 73, 20, 90, 15.0, true),
    (LMR_THREAT_DIV_10X, 30, 10, 50, 15.0, true),
    ...
    (SEE_CAP_MULT, 97, 40, 250, 12.0, true),
    (SEE_CAP_HIST, 10, 0, 40, 2.0, true),
    (BAD_NOISY_DEPTH_10X, 60, 40, 150, 15.0, true),       // BNFP depth cap
