...
tunables!(
    ...
    (HIST_BONUS_OFFSET, 58, 0, 400, 25.0),
    ...
    (CORR_HIST_DIV, 935, 256, 4096, 192.0),
    ...
    (ESCAPE_BONUS_Q, 13288, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 11527, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5671, 2000, 20000, 900.0),
    ...
    (FUT_THREATS_MARGIN, 26, 0, 200, 10.0),
    (DISCOVERED_ATTACK_BONUS, 6487, 0, 30000, 1500.0),
    ...
    (BATTERY_BONUS, 8097, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 5370, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 9940, 0, 20000, 1000.0),
    ...
    (TT_CUTOFF_HALFMOVE_MAX, 91, 50, 100, 3.0),  // was hardcoded 90 (TT cutoff halfmove gate, 5 sites)
);
