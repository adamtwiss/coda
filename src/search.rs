...
tunables!(
    ...
    (NMP_DEPTH_DIV,      2,    2,    6),
    (NMP_EVAL_DIV,     140,  100,  400),  // malus tune: 148→135
    (NMP_EVAL_MAX,       1,    1,    6),
    (NMP_VERIFY_DEPTH,  11,    8,   20),
    // RFP
    (RFP_DEPTH,          5,    4,   10),
    (RFP_MARGIN_IMP,    96,   30,  150),  // malus tune: 92→94
    (RFP_MARGIN_NOIMP, 132,   50,  200),  // malus tune: 140→137
    // Futility
    (FUT_BASE,         112,   20,  200),  // malus tune: 94→109
    (FUT_PER_DEPTH,    167,   40,  250),  // malus tune: 161→173
    // History pruning
    (HIST_PRUNE_DEPTH,   2,    1,    8),
    (HIST_PRUNE_MULT, 7213,  500, 50000),  // malus tune: 7224→6930
    // SEE pruning
    (SEE_QUIET_MULT,   21,    5,   80),  // malus tune: 23→24
    (SEE_CAP_MULT,    129,   30,  200),
    // LMR
    (LMR_HIST_DIV,   7079, 2000, 100000),  // malus tune: 9110→7454
    (LMR_C_QUIET,     128,   80,  300),  // malus tune: 138→132
    (LMR_C_CAP,       168,  100,  350),  // malus tune: 169→164
    // Singular extensions
    (SE_DEPTH,           6,    4,   12),
    // Aspiration windows
    (ASP_DELTA,         17,    5,   30),
    ...
    // Bad noisy
    (BAD_NOISY_MARGIN,  95,   30,  150),  // malus tune: 91→92
    // ProbCut
    ...
    (LMR_COMPLEXITY_DIV, 136, 30, 500),  // malus tune: 122→133
);
...
fn negamax(
    ...
    loop {
        ...
        // Removed !improving and !unstable guards (no engine has these — consensus)
