...
tunables!(
    // v9 post-#568 queen-7th retune (1000 iters, on queen-7th-bonus branch).
    // Applied from tune #568 raw outputs. Key movers vs tune-spec starts:
    // CORR_HIST_ERR_MAX +36%, CORR_W_CONT +25% (OPPOSITE to #562's -14%),
    // CAP_HIST_BASE +25% (OPPOSITE to #562's ~0), FUT_BASE -11%,
    // HIST_PRUNE_MULT +10% (cross-tune agreement with #562/#564),
    // LMR_C_QUIET -7%. QUEEN_7TH_BONUS itself unchanged (+0.9%).
    (NMP_BASE_R, 5, 2, 8),
    (NMP_DEPTH_DIV, 3, 1, 6),
    ...
    (HIST_PRUNE_MULT, 4610, 500, 50000),
    (SEE_QUIET_MULT, 44, 5, 80),
    (SEE_CAP_MULT, 144, 30, 200),
    (LMR_HIST_DIV, 7599, 2000, 100000),
    (LMR_C_QUIET, 118, 40, 300),
    (LMR_C_CAP, 103, 100, 350),
    (SE_DEPTH, 5, 4, 20),
    (ASP_DELTA, 13, 5, 30),
    (ASP_SCORE_DIV, 31775, 8000, 50000),
    (LMP_BASE, 13, 1, 15),
    (LMP_DEPTH, 9, 4, 20),
    (BAD_NOISY_MARGIN, 126, 30, 150),
    (PROBCUT_MARGIN, 191, 80, 300),
    (HINDSIGHT_THRESH, 191, 50, 400),
    (UNSTABLE_THRESH, 162, 50, 500),
    (SEE_MATERIAL_SCALE, 190, 30, 300),
    (QS_DELTA_MARGIN, 359, 100, 500),
    (QS_SEE_THRESHOLD, -31, -200, 0),
    (QS_MAX_CAPTURES, 27, 2, 32),
    (CORR_W_PAWN, 307, 100, 600),
    (CORR_W_NP, 112, 50, 400),
    (CORR_W_MINOR, 62, 30, 300),
    (CORR_W_MAJOR, 93, 30, 300),
    (CORR_W_CONT, 51, 30, 400),
    (FH_BLEND_DEPTH, 1, 0, 8),
    (HIST_BONUS_MULT, 293, 50, 400),
    (HIST_BONUS_MAX, 1609, 500, 3000),
    (CAP_HIST_MULT, 261, 50, 400),
    (CAP_HIST_BASE, 19, 0, 200),
    (CAP_HIST_MAX, 1630, 500, 3000),
    (DEXT_MARGIN, 9, 2, 50),
    (DEXT_CAP, 19, 4, 32),
    (QUIET_CHECK_BONUS, 9057, 2000, 30000),
    (LMR_COMPLEXITY_DIV, 174, 30, 500),
    (CORR_HIST_DIV, 1341, 256, 4096),
    (CORR_UPDATE_WEIGHT_MAX, 18, 4, 48),
    (CORR_BONUS_CAP_DIV, 4, 1, 16),
    (CORR_HIST_GRAIN_T, 10, 1, 32),
    (CORR_HIST_ERR_MAX, 4, 1, 64),
    (ESCAPE_BONUS_Q, 15993, 5000, 40000),
    (ESCAPE_BONUS_R, 12377, 3000, 30000),
    (ESCAPE_BONUS_MINOR, 9899, 2000, 20000),
    (NMP_KING_ZONE_MAX, 5, 2, 9),
    (PROBCUT_KING_ZONE_MAX, 5, 2, 9),
    (LMR_THREAT_DIV, 2, 1, 5),
    (LMR_KING_PRESSURE_DIV, 4, 2, 9),
    (FUT_THREATS_MARGIN, 37, 0, 200),
    (DISCOVERED_ATTACK_BONUS, 7605, 0, 30000),
    (SE_KING_PRESSURE_MARGIN, 5, 0, 30),
    (MVV_CAP_MULT, 17, 4, 64),
    (CONT_HIST_MULT, 3, 1, 8),
    (QUEEN_7TH_BONUS, 4035, 0, 20000),
);
