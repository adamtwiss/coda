...
tunables!(
    ...
    (NMP_BASE_R_10X, 51, 20, 80, 15.0, true),
    (NMP_DEPTH_DIV_10X, 28, 10, 200, 15.0, true),
    ...
    (NMP_VERIFY_DEPTH_10X, 60, 40, 200, 20.0, true),
    ...
    (RFP_DEEP_KNEE_10X, 42, 40, 170, 20.0, true),
    (RFP_DEEP_LINEAR, 52, 0, 200, 10.0, true),
    ...
    (FUT_BASE, 85, 0, 200, 9.0, true),
    (FUT_PER_DEPTH, 95, 40, 250, 10.5, true),
    ...
    (FUT_HIST_EXEMPT, 12810, 2000, 16384, 900.0, true),
    ...
    (SEE_QUIET_MULT, 17, 5, 80, 3.75, true),
    ...
    (LMR_HIST_DIV, 23128, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 5716, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 180, 40, 300, 13.0, true),
    (LMR_C_CAP, 256, 80, 350, 12.5, true),
    ...
    (LMR_BASE_CENTI, 46, 0, 120, 6.0, true),
    (LMR_ALLNODE_DECAY_NUM, 356, 0, 1600, 80.0, true),
    // Cut-node LMR bump, in centi-ply. Cut nodes reduce by this amount
    // (plus a further ply with no TT move); all-nodes keep +1.
    (LMR_CUTNODE_BUMP_CENTI, 248, 100, 500, 40.0, true),
    ...
    (LMR_TTALPHA_CENTI, 30, 0, 150, 8.0, true),
    ...
    (LMR_CUTOFF_ALLNODE_CENTI, 24, 0, 150, 8.0, true),
    ...
    (SE_DEPTH_10X, 53, 40, 200, 20.0, true),
    ...
    (LMP_BASE_10X, 61, 10, 150, 20.0, true),
    (LMP_DEPTH_10X, 113, 40, 200, 20.0, true),
    ...
    (LMP_MARGIN_THRESH, 76, 50, 500, 35.0, true),
    ...
    (LMR_ROOT_COEF_10X, 0, 0, 800, 40.0, true),
    (BAD_NOISY_MARGIN, 87, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 165, 80, 300, 11.0, true),
    ...
    (HINDSIGHT_THRESH, 118, 50, 400, 17.5, true),
    (QS_DELTA_MARGIN, 357, 100, 500, 20.0, true),
    ...
    (CORR_W_PAWN, 132, 100, 600, 25.0, true),
    (CORR_W_NP, 122, 0, 400, 17.5, true),
    ...
    (CORR_W_CONT, 196, 0, 400, 18.5, true),
    ...
    (CORR_W_TRANS, 100, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 230, 50, 400, 17.5, true),
    (HIST_BONUS_MAX, 1666, 500, 3000, 125.0, true),
    ...
    (CAP_HIST_MULT, 347, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 1826, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 520, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 30, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1183, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 310, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 2434, 500, 4000, 175.0, true),
    ...
    (DEXT_MARGIN_CORR, 17, 0, 64, 3.0, true),
    ...
    (SE_ROOT_DECIDED_CP, 690, 250, 5000, 150.0, true),
    ...
    (CORR_HIST_DIV, 324, 64, 4096, 64.0, true),
    ...
    (PROBCUT_KING_ZONE_MAX_10X, 89, 20, 90, 15.0, true),
    (LMR_THREAT_DIV_10X, 39, 10, 50, 15.0, true),
    (LMR_KING_PRESSURE_DIV_10X, 79, 20, 90, 15.0, true),
    ...
    (FUT_THREATS_MARGIN, 48, 0, 200, 10.0, true),
    ...
    (PROBCUT_ROOT_MIN_DEPTH_10X, 21, 0, 80, 8.0, true),
    (SEE_CAP_DEPTH_10X, 98, 30, 150, 15.0, true),         // SEE capture prune depth cap
    ...
    (BAD_NOISY_DEPTH_10X, 47, 40, 150, 15.0, true),       // BNFP depth cap
    ...
    (NMP_MIN_DEPTH_10X, 56, 20, 200, 15.0, true),
    (HINDSIGHT_MIN_DEPTH_10X, 28, 0, 200, 15.0, true),
