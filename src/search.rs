...
tunables!(
    ...
    (NMP_DEPTH_DIV,      3,    2,    6),
    (NMP_EVAL_DIV,     128,  100,  400),  // malus tune: 148→135
    (NMP_EVAL_MAX,       1,    1,    6),
    ...
    (FUT_PER_DEPTH,    183,   40,  250),  // malus tune: 161→173
    // History pruning
    (HIST_PRUNE_DEPTH,   2,    1,    8),
    (HIST_PRUNE_MULT, 7020,  500, 50000),  // malus tune: 7224→6930
    // SEE pruning
    (SEE_QUIET_MULT,   23,    5,   80),  // malus tune: 23→24
    (SEE_CAP_MULT,    123,   30,  200),
    // LMR
    (LMR_HIST_DIV,   6782, 2000, 100000),  // malus tune: 9110→7454
    (LMR_C_QUIET,     129,   80,  300),  // malus tune: 138→132
    (LMR_C_CAP,       165,  100,  350),  // malus tune: 169→164
    // Singular extensions
    (SE_DEPTH,           6,    4,   12),
    // Aspiration windows
    (ASP_DELTA,         17,    5,   30),
    ...
    (LMR_COMPLEXITY_DIV, 132, 30, 500),  // malus tune: 122→133
);
...
impl SearchInfo {
    ...
    fn eval(&mut self, board: &Board) -> i32 {
        ...
        // (Clarity: (200-hm)/200, Velvet: (128-hm)/128, Reckless: (200-hm)/200)
