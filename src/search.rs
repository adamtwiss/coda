...
tunables!(
    ...
    (NMP_BASE_R_10X, 68, 20, 80, 15.0, true),
    (NMP_DEPTH_DIV_10X, 50, 10, 200, 15.0, true),
    ...
    (RFP_MARGIN_NOIMP, 34, 0, 200, 7.5, true),
    ...
    (RFP_DEEP_KNEE_10X, 44, 40, 170, 20.0, true),
    ...
    (FUT_HIST_EXEMPT, 12035, 2000, 16384, 900.0, true),
    ...
    (LMR_HIST_DIV, 24762, 2000, 100000, 4900.0, true),
    ...
    (LMR_HIST_DIV_CAP, 3575, 1000, 20000, 1500.0, true),
    (LMR_C_QUIET, 175, 40, 300, 13.0, true),
    (LMR_C_CAP, 235, 80, 350, 12.5, true),
    ...
    (LMR_CUTNODE_BUMP_CENTI, 227, 100, 500, 40.0, true),
    ...
    (LMR_CUTOFF_CNT_CENTI, 80, 0, 250, 12.0, true),
    ...
    (SE_DEPTH_10X, 42, 40, 200, 20.0, true),
    ...
    (LMP_DEPTH_10X, 129, 40, 200, 20.0, true),
    ...
    (LMP_MARGIN_THRESH, 51, 50, 500, 35.0, true),
    (LMP_MARGIN_PCT, 56, 40, 100, 6.0, true),
    ...
    (LMR_ROOT_COEF_10X, 13, 0, 800, 40.0, true),
    (BAD_NOISY_MARGIN, 79, 30, 150, 6.0, true),
    (PROBCUT_MARGIN, 164, 80, 300, 11.0, true),
    ...
    (PROBCUT_ROOT_FADE_10X, 22, 10, 120, 10.0, true),
    (PROBCUT_ROOT_MARGIN, 69, 0, 120, 8.0, false),
    (HINDSIGHT_THRESH, 144, 50, 400, 17.5, true),
    (QS_DELTA_MARGIN, 379, 100, 500, 20.0, true),
    ...
    (CORR_W_PAWN, 102, 100, 600, 25.0, true),
    ...
    (CORR_W_CONT, 209, 0, 400, 18.5, true),
    ...
    (CORR_W_TRANS, 107, 0, 400, 18.5, true),
    ...
    (HIST_BONUS_MULT, 257, 50, 400, 17.5, true),
    ...
    (CAP_HIST_MULT, 338, 50, 400, 17.5, true),
    (CAP_HIST_MAX, 2096, 500, 3000, 125.0, true),
    ...
    (HIST_MALUS_MULT, 562, 50, 900, 40.0, true),
    (HIST_MALUS_OFFSET, 30, 0, 400, 25.0, false),
    (HIST_MALUS_MAX, 1179, 500, 4000, 175.0, true),
    (CAP_HIST_MALUS_MULT, 289, 50, 900, 40.0, true),
    (CAP_HIST_MALUS_BASE, 42, 0, 400, 25.0, false),
    (CAP_HIST_MALUS_MAX, 2287, 500, 4000, 175.0, true),
    ...
    (HIST_SIBLING_DIV, 150, 64, 1024, 40.0, true),
    ...
    (DEXT_MARGIN_CORR, 15, 0, 64, 3.0, true),
    ...
    (SE_ROOT_DECIDED_CP, 674, 250, 5000, 150.0, true),
    ...
    (QUIET_CHECK_SEE_MARGIN, 76, 0, 300, 12.0, true),
    ...
    (CORR_HIST_DIV, 335, 64, 4096, 64.0, true),
    ...
    (LMR_THREAT_DIV_10X, 41, 10, 50, 15.0, true),
    ...
    (FUT_THREATS_MARGIN, 46, 0, 200, 10.0, true),
    ...
    (PROBCUT_ROOT_MIN_DEPTH_10X, 20, 0, 80, 8.0, true),
    (SEE_CAP_DEPTH_10X, 86, 30, 150, 15.0, true),         // SEE capture prune depth cap
    ...
    (BAD_NOISY_DEPTH_10X, 49, 40, 150, 15.0, true),       // BNFP depth cap
