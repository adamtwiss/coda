...
tunables!(
    ...
    (FUT_BASE, 33, 20, 200, 9.0),
    (FUT_PER_DEPTH, 74, 40, 250, 10.5),
    (HIST_PRUNE_DEPTH, 3, 1, 8, 1.5),
    (HIST_PRUNE_MULT, 10164, 500, 50000, 2475.0),
    (SEE_QUIET_MULT, 34, 5, 80, 3.75),
    (LMR_HIST_DIV, 7324, 2000, 100000, 4900.0),
    (LMR_C_QUIET, 141, 40, 300, 13.0),
    (LMR_C_CAP, 105, 80, 350, 12.5),
    (SE_DEPTH, 4, 4, 20, 2.0),
    (ASP_DELTA, 12, 5, 30, 1.5),
    (ASP_SCORE_DIV, 28177, 8000, 50000, 2100.0),
    (LMP_BASE, 9, 1, 15, 2.0),
    (LMP_DEPTH, 10, 4, 20, 2.0),
    (BAD_NOISY_MARGIN, 72, 30, 150, 6.0),
    (PROBCUT_MARGIN, 200, 80, 300, 11.0),
    (HINDSIGHT_THRESH, 156, 50, 400, 17.5),
    (UNSTABLE_THRESH, 212, 50, 500, 22.5),
    (SEE_MATERIAL_SCALE, 243, 30, 300, 13.5),
    (QS_DELTA_MARGIN, 353, 100, 500, 20.0),
    (QS_SEE_THRESHOLD, -42, -200, 0, 10.0),
    (QS_MAX_CAPTURES, 28, 2, 32, 2.0),
    (CORR_W_PAWN, 304, 100, 600, 25.0),
    (CORR_W_NP, 71, 50, 400, 17.5),
    (CORR_W_MINOR, 60, 30, 300, 13.5),
    (CORR_W_MAJOR, 101, 30, 300, 13.5),
    (CORR_W_CONT, 33, 30, 400, 18.5),
    (FH_BLEND_DEPTH, 3, 0, 8, 1.5),
    (HIST_BONUS_MULT, 345, 50, 400, 17.5),
    (HIST_BONUS_MAX, 1829, 500, 3000, 125.0),
    ...
    (HIST_BONUS_OFFSET, 19, 0, 400, 25.0),
    (CAP_HIST_MULT, 277, 50, 400, 17.5),
    (CAP_HIST_BASE, 35, 0, 200, 10.0),
    (CAP_HIST_MAX, 1634, 500, 3000, 125.0),
    ...
    (DEXT_MARGIN_PV, 203, 50, 400, 15.0),
    (DEXT_MARGIN_QUIET, 6, 0, 100, 4.0),
    (DEXT_MARGIN_CORR, 16, 0, 64, 3.0),
    (DEXT_MARGIN_BASE, 44, -50, 150, 6.0),
    (DEXT_CAP, 12, 4, 32, 2.0),
    (QUIET_CHECK_BONUS, 11509, 2000, 30000, 1400.0),
    (LMR_COMPLEXITY_DIV, 189, 30, 500, 23.5),
    (CORR_HIST_DIV, 1085, 256, 4096, 192.0),
    (CORR_UPDATE_WEIGHT_MAX, 8, 4, 48, 2.2),
    (CORR_BONUS_CAP_DIV, 1, 1, 16, 1.5),
    (CORR_HIST_GRAIN_T, 12, 1, 32, 1.55),
    (CORR_HIST_ERR_MAX, 2, 1, 64, 3.15),
    (ESCAPE_BONUS_Q, 16082, 5000, 40000, 1750.0),
    (ESCAPE_BONUS_R, 10270, 3000, 30000, 1350.0),
    (ESCAPE_BONUS_MINOR, 5669, 2000, 20000, 900.0),
    ...
    (BATTERY_BONUS, 7901, 0, 20000, 1000.0),
    ...
    (QSEE_BONUS, 6242, 0, 20000, 1000.0),
    ...
    (KNIGHT_FORK_BONUS, 8560, 0, 20000, 1000.0),
    ...
    (FUT_LMR_DEPTH, 13, 5, 20, 1.5),         // was hardcoded 10; tune #743 → 9
    ...
    (TT_CUTOFF_HALFMOVE_MAX, 85, 50, 100, 3.0),  // was hardcoded 90 (TT cutoff halfmove gate, 5 sites)
);
