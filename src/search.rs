...
tunables!(
    ...
    (HIST_PRUNE_MULT, 5179,  500, 50000),
    // SEE pruning
    (SEE_QUIET_MULT,   37,    5,   80),
    (SEE_CAP_MULT,    139,   30,  200),
    // LMR
    (LMR_HIST_DIV,  10115, 2000, 100000),
    ...
    (ESCAPE_BONUS_Q,   19188, 5000, 40000),
    (ESCAPE_BONUS_R,   16414, 3000, 30000),
    (ESCAPE_BONUS_MINOR, 9350, 2000, 20000),
