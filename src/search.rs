...
tunables!(
    ...
    (NMP_DEPTH_DIV,      3,    2,    6),
    (NMP_EVAL_DIV,     131,  100,  400),  // malus tune: 148→135
    (NMP_EVAL_MAX,       1,    1,    6),
    ...
    // Futility
    (FUT_BASE,         112,   20,  200),  // malus tune: 94→109
    (FUT_PER_DEPTH,    174,   40,  250),  // malus tune: 161→173
    // History pruning
    (HIST_PRUNE_DEPTH,   2,    1,    8),
    (HIST_PRUNE_MULT, 6115,  500, 50000),  // malus tune: 7224→6930
    // SEE pruning
    (SEE_QUIET_MULT,   23,    5,   80),  // malus tune: 23→24
    (SEE_CAP_MULT,    129,   30,  200),
    // LMR
    (LMR_HIST_DIV,   6946, 2000, 100000),  // malus tune: 9110→7454
...
fn negamax(
    ...
    loop {
        ...
        // lowers the depth, making it easier to prune. bestScore updated on prune.
