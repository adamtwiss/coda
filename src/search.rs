...
tunables!(
    // NMP — SPSA 2500-iter tune for s400 combined (from s120 starting values)
    (NMP_BASE_R,         4,    2,    8),
    (NMP_DEPTH_DIV,      2,    2,    6),
    ...
    // Futility
    (FUT_BASE,         105,   20,  200),
    (FUT_PER_DEPTH,    175,   40,  250),
    // History pruning
    (HIST_PRUNE_DEPTH,   1,    1,    8),
    (HIST_PRUNE_MULT, 6414,  500, 50000),
    // SEE pruning
    (SEE_QUIET_MULT,   19,    5,   80),
    (SEE_CAP_MULT,    125,   30,  200),
    // LMR
    (LMR_HIST_DIV,   8064, 2000, 100000),
    (LMR_C_QUIET,     125,   80,  300),
    (LMR_C_CAP,       164,  100,  350),
    // Singular extensions
    (SE_DEPTH,           4,    4,   12),
    // Aspiration windows
    (ASP_DELTA,         16,    5,   30),
    (ASP_SCORE_DIV,  30557, 8000, 50000),
    // LMP
    (LMP_BASE,           7,    1,   15),
    (LMP_DEPTH,         15,    4,   20),
    // Bad noisy
    (BAD_NOISY_MARGIN,  97,   30,  150),
    // ProbCut
    (PROBCUT_MARGIN,   170,   80,  300),
    // Hindsight
    (HINDSIGHT_THRESH, 217,   50,  400),
    // Unstable position detection
    (UNSTABLE_THRESH,  200,   50,  500),
    // QS
    (QS_DELTA_MARGIN,  313,  100,  500),
    (QS_SEE_THRESHOLD,  -9, -200,    0),
    (QS_MAX_CAPTURES,   30,    2,   32),
    // Correction history weights
    (CORR_W_PAWN,      335,  100,  600),
    (CORR_W_NP,        122,   50,  400),
    (CORR_W_MINOR,      85,   30,  300),
    (CORR_W_MAJOR,      86,   30,  300),
    (CORR_W_CONT,       89,   30,  400),
    // Fail-high blend
    (FH_BLEND_DEPTH,     2,    1,    8),
    // History bonus
    (HIST_BONUS_MULT,  226,   50,  400),
    (HIST_BONUS_BASE,   52,    0,  200),
    (HIST_BONUS_MAX,  1609,  500, 3000),
    // Capture history bonus
    (CAP_HIST_MULT,    199,   50,  400),
    (CAP_HIST_BASE,     30,    0,  200),
    (CAP_HIST_MAX,    1355,  500, 3000),
    // Double extensions
    (DEXT_MARGIN,       14,    2,   50),
    (DEXT_CAP,          14,    4,   32),
    // Quiet check bonus
    (QUIET_CHECK_BONUS, 11192, 2000, 30000),
    // LMR complexity
    (LMR_COMPLEXITY_DIV, 141, 30, 500),
);
