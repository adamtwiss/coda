...
OPP=(
  "SF:cmd=/home/adam/chess/engines/Stockfish/src/stockfish proto=uci option.Threads=1 option.Hash=128"
  "Reckless:cmd=/home/adam/chess/engines/Reckless/reckless proto=uci option.Threads=1 option.Hash=128"
)
ROUNDS=${1:-150}   # games/opponent/condition = ROUNDS*2 (both colours)
CONC=${2:-16}
OUT=/tmp/tm_ceiling_top
mkdir -p $OUT
