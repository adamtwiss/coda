...
fn main() {
    ...
    let final_lr: f32 = 0.001 * 0.3f32.powi(5); // our standard final LR
    ...
    let schedule = TrainingSchedule {
        net_id: "exp-d-wdl030-low-lr".to_string(),
        eval_scale: 400.0,
        steps: TrainingSteps {
            batch_size: 16_384,
    ...
    println!("=== Experiment D: WDL=0.3 + lower final LR ===");
    println!("768pw → CReLU → pairwise → SCReLU L1(16) → SCReLU L2(32) → 1×8");
    println!("WDL: 0.3, LR: {} → {}, Warmup: {} SBs", initial_lr, final_lr, warmup_sbs);
