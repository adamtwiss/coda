/// Experiment I: v5 768pw + 1 output bucket + Velvet tricks
...
fn main() {
    ...
    let schedule = TrainingSchedule {
        net_id: "exp-i-v5-768pw-1bucket".to_string(),
        eval_scale: 400.0,
        steps: TrainingSteps {
            batch_size: 16_384,
    ...
    println!("=== Experiment H: v5 768pw + Velvet Tricks ===");
    println!("768pw → CReLU → pairwise, 1 output bucket (Velvet-style, tests output bucket hypothesis)");
    println!("Power-2.6 loss, WDL={}, 12 T80 files, warmup {} SBs", wdl_val, warmup_sbs);
