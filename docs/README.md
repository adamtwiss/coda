...
- [`correctness_audit_2026-04-22.md`](correctness_audit_2026-04-22.md) — **Deep correctness audit of existing code.** 9 parallel subsystem reviews. 7 CRITICAL (is_pseudo_legal EP holes, TB cache halfmove, NMP stale stack, NEON SCReLU shift, TB_WIN ply-adjust, stale TM limits, convert-checkpoint momentum), ~30 LIKELY, ~25 SPECULATIVE. Ranked fix batches. Bullet trainer audit still pending.
