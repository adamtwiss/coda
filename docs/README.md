...
- [`cross_engine_comparison_2026-04-25.md`](cross_engine_comparison_2026-04-25.md) — **Cross-engine comparison vs top 17 engines.** 5 parallel mechanism-class surveys (move ordering, pruning/reductions, extensions, eval, corrhist+novel) covering Stockfish/Reckless/Obsidian/PlentyChess/Integral/Berserk/Viridithas/Quanticade/Clover/Alexandria/Tarnished/Halogen/Astra/RubiChess/Stormphrax/Horsie/Caissa. **17 Coda outliers vs 5+ engine consensus** (headline: `LMR_C_QUIET > LMR_C_CAP` reduces captures MORE than quiets — inverted vs every consensus engine; no triple extension; no stm dim on main quiet history; no symmetric enter-threat penalty; halfmove `(100-hm)/100` over-decays; pawn history size 512 is smallest in field). **19 novel mechanisms** 1-3 engines have. Tier-1 cumulative envelope +20-40 Elo; full ranked queue of 24 experiments.
